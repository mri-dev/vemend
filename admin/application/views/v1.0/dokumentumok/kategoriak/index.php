<div style="float:right;">
	<a href="/dokumentumok/" class="btn btn-default"><i class="fa fa-th"></i> dokumentumok</a>
	<a href="/dokumentumok/upload" class="btn btn-primary"><i class="fa fa-plus"></i> új dokumentum feltöltése</a>
</div>
