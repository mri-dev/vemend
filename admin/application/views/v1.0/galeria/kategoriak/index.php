<div style="float:right;">
	<a href="/galeria/" class="btn btn-default"><i class="fa fa-th"></i> képek kezelése</a>
</div>
<h1>Galéria mappák / kollekciók</h1>
<? if($this->err): ?>
	<?=$this->bmsg?>
<? endif; ?>
<div class="row">
	<div class="col-md-4">
		...
		<div class="con con-del">
			<h2>Mappa törlése</h2>
			Biztos benne, hogy törli a(z) <strong><u><?=$this->category_d->getName()?></u></strong> elnevezésű mappát? A művelet nem visszavonható!
			<div class="row np">
		...
		<div class="con <?=($this->category ? 'con-edit':'')?>">
			<h2><?=($this->category ? 'Mappa szerkesztése':'Új mappa létrehozás')?></h2>
			<div>
				<form action="" method="post">
					<div class="row np">
          ...
          <?php if (false): ?>
					...
					<div class="row np">
						<div class="col-md-12">
							<label for="parent_category">Szülő mappa</label>
	...
	<div class="col-md-8">
		<div class="con">
			...
			<div class="row np row-head">
				<div class="col-md-6"><em>Mappa</em></div>
